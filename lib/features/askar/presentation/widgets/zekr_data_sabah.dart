...
class ZekrSobah extends StatelessWidget {
  const ZekrSobah({super.key, required this.state });
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ListView.separated(
        ...
        itemCount: state.azkarSabah.length,
              ...
              return Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      '  ${state.azkarSabah[index].bless.toString()}',
                      textAlign: TextAlign.center,
                      style: const TextStyle(
                        color: Colors.black,
                        fontSize: 20,
